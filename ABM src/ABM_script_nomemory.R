...
while(iteratie < iteratiestotaal){
  ...
  steps_to_ripen<- 3120 #In 60 dagen bereikt het fruit een waarde van 100 (value to ripen) -> 13*4*60 = 3120 stappen. Bajinath & Ramcharun, 1983; Eisikowitch, 1968; Piedra-Malagón et al,2019 
